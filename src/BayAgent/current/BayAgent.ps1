...
function Stop-SessionDisplay {
    ...
    if ([string]::IsNullOrWhiteSpace([string]$url)) { $url = "file:///C:/AllBirdies/SessionDisplay/current/index.html" }
    if ([string]::IsNullOrWhiteSpace([string]$profileDir)) { $profileDir = "C:\AllBirdies\SessionDisplay\edge-profile" }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUhxcMM73qlzPuwg4Rk8xJDjxM
# vqqgggMcMIIDGDCCAgCgAwIBAgIQcB7+YhwgR7ZJib3KL4WIcjANBgkqhkiG9w0B
...
# BAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUGeBbEqQXjovdZ3gwv3pBevBMh5YwDQYJ
# KoZIhvcNAQEBBQAEggEASdnCVbNxdspCugjutuT3AgcKE5SrwB0qWUMgH1NQB38d
# 78rxnhz+b7IRSrSN6hygvGY/rgEHA/O0IG/rGMA4C5IUMsxqGrE1IMDwKXUPfNoX
# fHvYjM5jhzGE+c90g/BQquP/eevuSjUOdbZr0x2tg6TmERThafP6Eqgb6vCljSOV
# zxkKhkYo8pO0RaR5bRcLBFv46yCmhd3AJ7NdmKDxSh4OM6tWHGeWd1OA++xiYv9m
# A3nJjSU5x2jpumq+NaiFH/zQSjK1wRMc1BsM8Xxt5A/RudFg4P49QCrigX4UUPfd
# yy/7LDlcOnSCClF4bOu5rksXgsrHsWAzsntwY7wm3g==
